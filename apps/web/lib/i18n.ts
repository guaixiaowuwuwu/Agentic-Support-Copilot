...
export const dictionaries = {
  zh: {
    ...
    state: {
      ...
      approvalEmptyBody: "需要人工审批时，审批状态和客户可见回复草稿会显示在这里。",
    ...
    audit: {
      ...
      filters: "筛选",
      tenant: "租户",
      tenantPlaceholder: "acme",
      actor: "操作者",
      actorPlaceholder: "lead@acme.example",
      action: "动作",
      actionPlaceholder: "tool_call_failed",
      target: "目标",
      targetPlaceholder: "run、ticket、approval",
      start: "开始时间",
      end: "结束时间",
      search: "查询",
      reset: "重置",
  ...
  en: {
    ...
    state: {
      ...
      approvalEmptyTitle: "No approval",
      approvalEmptyBody: "When human approval is required, the approval state and customer-facing draft appear here.",
    ...
    knowledge: {
      ...
      metricsLabel: "Knowledge metrics",
      totalDocuments: "Documents",
      totalChunks: "Chunks",
      readyDocuments: "Ready docs",
    ...
    admin: {
      ...
      appEnv: "App env",
      trustedRequired: "Trusted identity required",
      enabled: "Enabled",
      disabled: "Disabled",
    ...
    trace: {
      ...
      retryRun: "Retry run",
      cancelFailed: "Cancel run failed",
      retryFailed: "Retry run failed"
    },
    status: {
      open: "open",
      queued: "queued",
